...
public class Perder extends javax.swing.JFrame {
   ...
   public void mostrar_puntos(int puntos){
       jTextField3.setText(String.valueOf(puntos));
   }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("¿GUARDAR ESTA PARTIDA?");
        ...
        jButton7.setFont(new java.awt.Font("Eras Medium ITC", 1, 12)); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "¡Ingresa el nombre de un jugador!");
            ...
            int p= obj.buscar_pn(jTextField4.getText());
            if (p==-1){
            }
            else{
                obj.añade_jugada(p, Integer.parseInt(jTextField3.getText()));
                Gestor_Usuarios obj = new Gestor_Usuarios();
                obj.setVisible(true);
                dispose();
            }
